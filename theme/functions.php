...
if ( ! function_exists( 'judasasbotasde_setup' ) ) :
	...
	function judasasbotasde_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => __( 'Primary', 'judasasbotasde' ),
				'menu-2' => __( 'Footer Menu', 'judasasbotasde' ),
			)
		);
 ...
 */
function judasasbotasde_widgets_init() {
	register_sidebar(
		array(
			'name'          => __( 'Footer', 'judasasbotasde' ),
			'id'            => 'sidebar-1',
			'description'   => __( 'Add widgets here to appear in your footer.', 'judasasbotasde' ),
...
add_action( 'widgets_init', 'judasasbotasde_widgets_init' );

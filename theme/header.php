...
<body class="overflow-x-hidden">
	...
	<header class="grid grid-cols-12 outline outline-offset-4 outline-1 outline-[#e5e7eb] mb-6">
		<!-- Hamburguer menu -->
		<nav class="col-span-2 xl:col-span-1 flex flex-row justify-center content-center items-center border-r border-b-2 py-2">
		...
		<!-- Main menu -->
		<nav class="flex col-span-4 xl:col-span-8 gap-6 flex-row justify-center content-center items-center border-r border-b-2 py-2 ">
			<?php
			wp_nav_menu(array(
				'menu' => 'Category',
				'container' => false,
		...
		<!-- Email button -->
		<nav class="col-span-2 xl:col-span-1 flex flex-row justify-center content-center items-center border-b-2 py-2">

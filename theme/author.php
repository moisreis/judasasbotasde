...
$author_site = get_the_author_meta('user_url', $author->ID);
                ...
                <div class="flex flex-col xl:flex-row gap-0 xl:gap-6 justify-start xl:items-center content-center mt-3 xl:mt-0 mb-6">
                    ...
                    <?php if ($author_email) : ?>
                        <a href="mailto:<?php echo esc_html($author_email); ?>">
                            <div class="flex flex-row justify-start gap-2 items-center content-center mt-2">
                                ...
                                <?php if ($author_email) : ?>
                                    <span class="text-sm underline text-blue-600/80"><?php echo esc_html($author_email); ?></span>
                                <?php endif; ?>
                            </div>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if ($author_twitter) : ?>
                        <div class="flex flex-row justify-start gap-2 items-center content-center mt-2">
                            ...
                            <span class="text-sm text-blue-600/80"><?php echo esc_html($author_twitter); ?></span>
                        </div>
                    <?php endif; ?>
                    <!-- Instagram -->
                    <?php if ($author_instagram) : ?>
                        <div class="flex flex-row justify-start gap-2 items-center content-center mt-2">
                            ...
                            <span class="text-sm text-blue-600/80"><?php echo esc_html($author_instagram); ?></span>
                        </div>
                    <?php endif; ?>
                    <?php if ($author_site) : ?>
                        <a href="<?php echo esc_html($author_site); ?>">
                            <div class="flex flex-row justify-start gap-2 items-center content-center mt-2">
                                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-blue-600/80">
                                ...
                                <span class="text-sm underline text-blue-600/80"><?php echo esc_html($author_site); ?></span>
                            </div>
                        </a>
                    <?php endif; ?>
                </div>

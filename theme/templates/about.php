...
<main class="p-8 xl:p-12">
    ...
    <section class="flex flex-col mb-12">
        ...
        <header>
            <h1 class="capitalize font-serif text-4xl font-black mb-6 after:block after:h-[8px] after:mt-2 after:w-full after:border-t-2 after:border-b after:border-t-foreground">Sobre nós</h1>
        </header>
        <!-- General info -->
    ...
    <section class="flex flex-col">
        ...
        <h1 class="capitalize font-serif text-4xl font-black mb-6 after:block after:h-[8px] after:mt-2 after:w-full after:border-t-2 after:border-b after:border-t-foreground">Nossos colaboradores</h1>
